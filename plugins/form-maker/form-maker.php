<?php
/**
 * Plugin Name: Form Maker- ULL
 * Plugin URI: https://web-dorado.com/products/form-maker-wordpress.html
 * Description: Plugin modificado para su uso de formulario en el portal OpenPyme de la OSL. This plugin is a modern and advanced tool for easy and fast creating of a WordPress Form. The backend interface is intuitive and user friendly which allows users far from scripting and programming to create WordPress Forms.
 * Version: 101.10.10
 * Author: WebDorado
