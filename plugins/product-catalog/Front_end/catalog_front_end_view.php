 ...
 ob_start();
	...
	$slidechangespeed=$catalog[0]->param;
       ...
       // var_dump($paramssld3);
        ...
        $paramssld["ht_view0_linkbutton_text"] = "Ver Catálogo";
        ...
        $paramssld["ht_view0_show_thumbs"] = "off";
        ...
        $paramssld["ht_view1_linkbutton_text"] = "Ver Catálogo";
        ...
        $paramssld["ht_view1_show_thumbs"] = "off";
        ...
        $paramssld["ht_view2_element_linkbutton_text"] = "Ver Catálogo";
        ...
        $paramssld["ht_view2_popup_linkbutton_text"] = "Ver Catálogo";
        ...
        $paramssld["ht_view2_show_thumbs"] = "off";
        ...
        $paramssld["ht_view3_linkbutton_text"] = "Ver Catálogo";
        ...
        $paramssld["ht_view3_show_thumbs"] = "off";
        ...
        $paramssld["ht_view5_linkbutton_text"] = "Ver Catálogo";
        ...
        $paramssld["ht_view5_show_thumbs"] = "off";
        ...
        $paramssld["ht_view3_allow_zooming"] = "off";
        ...
        $paramssld["ht_view5_allow_zooming"] = "off";
...
<?php
    function html_single_product_page($productArray, $paramssld, $paramssld2, $paramssld3, $paramssld4, $ratingsArray, $reviewsArray, $spamReviewsArray, $captchaFirstNum, $captchaSecondNum, $captcha_val){
        ...
        $paramssld["ht_single_product_allow_zooming"] = "off";
        ...
        $paramssld["ht_single_product_show_thumbs"] = "off";
        ...
        $paramssld2["ht_view0_linkbutton_text"] = "Ver Catálogo";
        ...
        $paramssld2["ht_view0_show_thumbs"] = "off";
        ...
        $paramssld2["ht_view1_linkbutton_text"] = "Ver Catálogo";
        ...
        $paramssld2["ht_view1_show_thumbs"] = "off";
        ...
        $paramssld2["ht_view2_element_linkbutton_text"] = "Ver Catálogo";
        ...
        $paramssld2["ht_view2_popup_linkbutton_text"] = "Ver Catálogo";
        ...
        $paramssld2["ht_view2_show_thumbs"] = "off";
        ...
        $paramssld2["ht_view3_linkbutton_text"] = "Ver Catálogo";
        ...
        $paramssld2["ht_view3_show_thumbs"] = "off";
        ...
        $paramssld2["ht_view5_linkbutton_text"] = "Ver Catálogo";
        ...
        $paramssld2["ht_view5_show_thumbs"] = "off";
        ...
        $paramssld2['ht_catalog_zoom_lens_hide'] = "false";
        $paramssld2["ht_view3_allow_lightbox"] = "off";
        $paramssld2["ht_catalog_zoom_thumbs_zoom"] = "off";
        $paramssld2["ht_view3_allow_zooming"] = "off";
        $paramssld["ht_view0_allow_zooming"] = "off";
        $paramssld["ht_view0_allow_lightbox"] = "off";
        $paramssld["ht_view1_allow_zooming"] = "off";
        $paramssld["ht_view1_allow_lightbox"] = "off";
...
//                                                                if(count($separateParamAndChildsInArray == 1)) echo '<li class="value-block"></li>';
                                                                ...
                                                                echo '<li class="value-block">'.  make_clickable($separateParamAndChild).'</li>';
                                                        }
                                                }
                                            }
                                        }
	...
	<?php 
		$link = $productArray->id;

		echo '<a href= "' . site_url() . '/actualizar/?id=' . $link . '" class="btn btn-info" role="button"> Solicitar actualización de producto</a>'; 
