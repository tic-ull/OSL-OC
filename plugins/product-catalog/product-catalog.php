...
/*
Plugin Name: Huge IT Product Catalog - ULL
Plugin URI: https://huge-it.com/product-catalog
Description: Plugin modificado del original con el objetivo de traducirlo al español y realizar las modificaciones pertinentes para aplicarlo a OpenPYME y SELIBRE.
Version: 100.10.10
Author: Huge-IT
...
function huge_it_catalog_options_panel()
{
    ...
    // Páginas administrativas para el buscador global y alternativas a
    add_submenu_page('catalogs_huge_it_catalog', 'Global Search', 'Global Search', 'manage_options', 
    'huge-it-global-search', 'huge_it_global_search_administration_page');
    add_submenu_page('catalogs_huge_it_catalog', 'Alternative to', 'Alternative to', 'manage_options',
                    'huge-it-alternative-to', 'huge_it_alternative_to_administration_page');
...
function huge_it_alternative_to_administration_page() {
    include_once("admin/alternative_to_view.php");
}
                ...
                switch ($view){
                    case 0:
                        ...
                        foreach($moreImagesInArray as $key=>$row)
                        {
                            ...
                            $moreImages .= "<div class='element_".$catalog_id."' data-symbol='".$row->name."' data-element-id='".$row->id."' data-category='alkaline-earth'>";
			...
			<div class='popup-wrapper_".$catalog_id."'>
                    ...
                    case 3:
                        ...
                        foreach($moreImagesInArray as $key=>$row)
                        {
                            ...
                            $moreImages .= "<div class='element_".$catalog_id."' data-symbol='".$row->name."'  data-element-id='".$row->id."'  data-category='alkaline-earth' data>";
...
('ht_catalog_general_linkbutton_text', 'ht_catalog_general_linkbutton_text', 'Ver catálogo'),
